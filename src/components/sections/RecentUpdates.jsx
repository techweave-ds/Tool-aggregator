    ...
    <section className="py-24 px-6" style={{ background: 'var(--surface)' }}>
      <div className="max-w-6xl mx-auto">
        <motion.div initial={{ opacity:0, y:20 }} whileInView={{ opacity:1, y:0 }} viewport={{ once:true }}
          ...
          <div>
            <p className="text-xs font-mono tracking-widest mb-3" style={{ color: 'var(--accent)' }}>05 / UPDATES</p>
            <h2 className="font-display font-bold" style={{ fontSize: 'clamp(28px,4vw,48px)', color: 'var(--text)' }}>
              Recent <span className="text-gradient">releases</span>
            </h2>
          </div>
          <Link to="/tools" className="hidden md:flex items-center gap-1.5 text-sm" style={{ color: 'var(--accent)' }}>
              ...
              >
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs line-clamp-2 mb-2" style={{ color: 'var(--text3)' }}>
